...
//========================================================================================================
IMPLEMENT_DYNAMIC(CChocoItemEditor, CPropertyPage)
//========================================================================================================
CChocoItemEditor::CChocoItemEditor()
	: CPropertyPage(CChocoItemEditor::IDD)
{
...
//========================================================================================================
void CChocoItemEditor::DoDataExchange(CDataExchange* pDX)
{
...
//========================================================================================================
BOOL CChocoItemEditor::OnInitDialog() 
{
	CBitmap bmp;
	int i = NULL;
	int dx = NULL;
	...
	for (int i=0; i<324; i++)
	{
		iIndex = iGetIndexFromDigit(ItemTable, _countof(ItemTable), pSlot->ChocoStore[i].ItemDigit);
		if (iIndex == -1)
		{
		...
		else
		{
			...
			m_InvItems.InsertItem(&lvItem);
			sprintf_s(szQty, _countof(szQty), "%u", pSlot->ChocoStore[i].Quantity);
...
//========================================================================================================
BEGIN_MESSAGE_MAP(CChocoItemEditor, CPropertyPage)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_INVENTORY_ITEMS, &CChocoItemEditor::OnLvnItemchangedInventoryItems)
	ON_NOTIFY(TVN_SELCHANGED, IDC_INV_ITEM_LIST, &CChocoItemEditor::OnTvnSelchangedInvItemList)
	ON_BN_CLICKED(IDC_ADD_ITEM, &CChocoItemEditor::OnBnClickedAddItem)
	ON_BN_CLICKED(IDC_REMOVE_ITEM, &CChocoItemEditor::OnBnClickedRemoveItem)
END_MESSAGE_MAP()
//========================================================================================================
...
// Thanks!
//========================================================================================================
void CChocoItemEditor::OnLvnItemchangedInventoryItems(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//========================================================================================================
void CChocoItemEditor::OnTvnSelchangedInvItemList(NMHDR *pNMHDR, LRESULT *pResult)
{
...
//========================================================================================================
void CChocoItemEditor::UpdateItems()
{
	int i = NULL;
	char szQty[32] = {0};
	...
	{
		// Get Item Digit
		pSlot->ChocoStore[i].ItemDigit = m_InvItems.GetItemData(i);

		// Get Quantity
		m_InvItems.GetItemText(i, 1, szQty, _countof(szQty));
		pSlot->ChocoStore[i].Quantity = strtoul(szQty, NULL, NULL);
	}
}
//========================================================================================================
void CChocoItemEditor::OnBnClickedAddItem()
{
...
//========================================================================================================
void CChocoItemEditor::OnBnClickedRemoveItem()
{
